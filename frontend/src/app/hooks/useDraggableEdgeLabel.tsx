...
const setLabelPosition = (
  draggableEdgeLabelRef: RefObject<HTMLDivElement | null>,
  edgePathRef: RefObject<SVGPathElement | null>,
   edgeText: React.MutableRefObject<{ index: number }>
) => {
...
): [RefObject<SVGPathElement | null>, RefObject<HTMLDivElement | null>] => {
